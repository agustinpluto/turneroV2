    ...
    <main>
      ...
      <hr class="col-3 col-md-2 mb-5">
            <form method="post">
                ...
                <h1 class="h3 mb-3 fw-normal">Creación de cuenta</h1>

                <?php

                include "../funciones/procesarRegistro.php";
                ...
                <div class="form-floating my-5">
                    ...
                    <label for="floatingInput">DNI - MATRICULA</label>
                </div>
                <div class="form-floating my-5">
                ...
                <div class="container-fluid d-flex justify-content-center align-items-center flex-column">
                    <button class="btn btn-lg btn-primary w-75 m-1" type="submit" name="botonRegistro" style="background-color: #905597;border-color: #8e8cbb;">Registrarse</button>
                    <a href="login.php" class="btn btn-lg btn-primary w-75 m-1" name="botonRegistro" style="background-color: #905597;border-color: #8e8cbb;">Iniciar sesión</a>
                </div>
