        ...
        <form method="post">
            ...
            <div class="container-fluid d-flex">
                ...
                <div class="container-fluid d-flex justify-content-center align-items-center">
                    <h1 class="h3 mb-3 fw-normal">Turnos para el Departamento de Coordinación, Supervisión de Maestras de Apoyo y Acompañantes Terapéuticas</h1>
            ...
            if (isset($_POST['botonRegistro'])) {
                ...
                $sql = "INSERT INTO turnosd (paciente, departamento, fecha, hora) VALUES('$dni', '2','$formatted_date','$formatted_time')";
                $resultado = mysqli_query($conexion, $sql);
            }
            ?>

            <div class="container-fluid d-flex justify-content-center align-items-center flex-column">
                <button class="btn btn-lg btn-primary w-75 m-1" type="submit" name="botonRegistro" style="background-color: #905597;border-color: #8e8db7;">Solicitar turno</button>
