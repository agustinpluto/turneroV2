...
<body class="text-center">
            ...
            <form method="post">
                ...
                <form method="post">
                    ...
                    if (isset($_POST['botonRegistro'])) {
                        if ($_POST['trabajadorSocialSelect'] != 'no') {
                            include "../../database/conexion.php";
                            ...
                            if ($apellido_medico = "Rondine") {
                                $fecha = $_POST["diasRondineSelect"];
        ...
        <script>
            var trabajadoraSocialSelect = document.getElementById('trabajadoraSocialSelect');
            horariosRondineSelect.style.display = "none"
            trabajadoraSocialSelect.addEventListener("change", function() {
                var diasRondineSelect = document.getElementById('diasRondineSelect')
                var apellido = trabajadoraSocialSelect.value;
