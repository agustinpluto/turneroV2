                        ...
                        if ($apellido_medico = "Ros") {
                            ...
                            if ($dia_de_la_semana == 'Friday') {
                                ...
                                if (repetido($conexion, $apellido_m, $fecha, $viernes)) {
                                    ...
                                    header("location: https://turnero-integra.com.ar/enviarMail.php?email=agustinpluto@gmail.com&paciente=" . $nombre_paciente . ", " . $apellido_paciente . "&fecha=" . $fecha . "&hora=" . $viernes . "");
                                }
                            }
                        }
                    }
